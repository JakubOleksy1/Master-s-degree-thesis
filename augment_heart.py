...
# Ścieżki
input_path = r"C:\Users\jakub\Visual Studio Code sem2\Magister\augmented\heart_augmented.csv"
output_path = r"C:\Users\jakub\Visual Studio Code sem2\Magister\augmented\heart_augmented.csv"

# Wczytaj dane
df_heart = pd.read_csv(input_path)
print("Oryginalny rozmiar:", len(df_heart))

# Funkcja augmentująca
def augment_heart(data, target_size=3000, random_state=42):
...
# Augmentacja
df_augmented = augment_heart(df_heart, target_size=500)
